-- MOD: Allow HTTP1.1 client pretending to be 1.0??? or whatever??? to have no body
--[[
...
local function decoder()
  ...
  function decodeHead(chunk, index)
    ...
    if not isResponse and (not (chunkedEncoding or (contentLength and contentLength > 0)))
